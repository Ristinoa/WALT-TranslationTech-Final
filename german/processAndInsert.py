...
# ! This file is configured to work only on GERMAN files
...
strings_block_start = re.compile(
    r'^\s*translate\s+german\s+strings\s*:\s*$',
    re.IGNORECASE
)
...
if __name__ == "__main__":
    ...
    processed_files = ["script_translated_DE.txt", "common_extracted_DE.txt", "screens_extracted_DE.txt"]
