# TODO: Translation updated at 2025-11-12 21:22

translate spanish strings:

    # renpy/common/000statements.rpy:28
    old "Click to play the video."
    new "Autoexpresión deshabilitada."
    ...
    old "selected"
    new "Seleccionar el mando para calibrar"
    ...
    new "La compatibilidad con voz propia es limitada cuando se utiliza una pantalla táctil."
    ...
    new "Caída de volumen con voz propia"
    ...
    old "Disable"
    new "El servidor de sincronización de RenPy agotó el tiempo de espera."
    ...
    old "DejaVu Sans"
    new "El servidor de sincronización RenPy no tiene una copia de esta sincronización. Es posible que el ID de sincronización no sea válido o que se haya agotado el tiempo de espera."
    ...
    new "Esta computadora está usando renderizado de software."

    # renpy/common/00accessibility.rpy:224
    old "Text Size Scaling"
    new "El archivo {a=edit:1:log.txt}log.txt{/a} puede contener información para ayudarle a determinar qué está mal con su computadora."
    ...
    new "Las opciones de este menú están destinadas a mejorar la accesibilidad. Es posible que no funcionen con todos los juegos y algunas combinaciones de opciones pueden hacer que el juego no se pueda jugar. Esto no es un problema del juego ni del motor. Para obtener mejores resultados al cambiar fuentes, intente mantener el tamaño del texto igual al original."
    ...
    old "File page quick"
    new "Archivo rápido de página"

    # renpy/common/00action_file.rpy:617
    old "File page [text]"
    new "Página de archivo [texto]"
    ...
    new "Haga clic para establecer la transformación, haga clic derecho para agregar a la lista de transformaciones."
    ...
    new "Haga clic para configurar, haga clic derecho para agregar a la lista posterior."
    ...
    new "¿Estás seguro de que deseas sobrescribir tu partida guardada?"
    ...
    new "¿Está seguro de que desea volver al menú principal?\\nEsto perderá el progreso no guardado."

    # renpy/common/00gui.rpy:454
    old "Are you sure you want to continue where you left off?"
    new "¿Estás seguro de que deseas continuar donde lo dejaste?"

    # renpy/common/00gui.rpy:455
    old "Are you sure you want to end the replay?"
    new "¿Estás seguro de que deseas finalizar la repetición?"

    # renpy/common/00gui.rpy:456
    old "Are you sure you want to begin skipping?"
    new "¿Estás seguro de que deseas comenzar a saltar?"
    ...
    new "¿Estás seguro de que deseas pasar el diálogo no visto a la siguiente opción?"
    ...
    new "Avanzar automáticamente después de hacer clic"
    ...
    new "Desactivación de la autoexpresión"
    ...
    old "debug voicing"
    new "Esto se pondrá en contacto con el {a=https://sync.renpy.org}Servidor de sincronización RenPy{/a}."

    # renpy/common/00preferences.rpy:471
    old "debug voicing enable"
    new "habilitación de voz de depuración"

    # renpy/common/00preferences.rpy:473
    old "debug voicing disable"
    new "Desactivación de la voz de depuración"
    ...
    new "Sonido del portapapeles habilitado. Presione shift+C para deshabilitar."

    # renpy/common/00preferences.rpy:725
    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "La autoexpresión diría \\[renpy.display.tts.last]\\. Presione alt+shift+V para deshabilitar."

    # renpy/common/00preferences.rpy:727
    old "Self-voicing enabled. Press 'v' to disable."
    new "Autoexpresión habilitada. Presione v para deshabilitar."
    ...
    old "(hide)"
    new "Esto cargará tus partidas guardadas al {a=https://sync.renpy.org}Servidor de sincronización RenPy{/a}.\\n¿Quieres continuar?"
    ...
    new "No se pudo conectar al servidor de sincronización RenPy."
    ...
    new "Se produjo un error desconocido al conectarse al servidor de sincronización RenPy."
    ...
    new "Imagen [índice] de [cuenta] bloqueada."
    ...
    new "Esta computadora tiene un problema al mostrar gráficos: [problema]."

    # renpy/common/00gltest.rpy:220
    old "Its graphics drivers may be out of date or not operating correctly. This can lead to slow or incorrect graphics display."
    new "Es posible que sus controladores gráficos estén desactualizados o no funcionen correctamente. Esto puede provocar que los gráficos se visualicen de forma lenta o incorrecta."
    ...
    new "Puedes encontrar más detalles sobre cómo solucionar esto en la {a=[url]}documentación{/a}."
    ...
    new "Presione o mueva el [control!s] [tipo]."
